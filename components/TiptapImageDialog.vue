...
<template>
  <Dialog title="Pilih Gambar" :show="show" @close="closeDialog">
    <div v-bind="getRootProps()" class="border border-gray-300 rounded-lg p-4">
      ...
      <div
        ...
        class="border border-gray-300 rounded-lg border-dashed px-8 py-12"
      >
        <p
          v-if="isDragActive"
          class="text-center text-sm text-gray-700 font-medium"
        >
          Drop the files here ...
        </p>
        <p v-else class="text-center text-sm text-gray-700 font-medium">
